...
Public Class MasterPage
    ...
    Private Sub ArmarMenuCompleto()
        ...
        Me.Menu.Items.Item(5).ChildItems.Add(New MenuItem("Cargar Partidas", "CargarPartidas", Nothing, "/CargarPartidas.aspx"))

        Me.Menu.Items.Add(New MenuItem("Empresa", "Institucional", Nothing, "/Institucional.aspx"))
        Me.Menu.Items.Add(New MenuItem("Area de Cliente", "Cliente"))
        Me.Menu.Items.Item(7).ChildItems.Add(New MenuItem("Carrito", "Carrito", Nothing, "/Orders.aspx"))
        Me.Menu.Items.Item(7).ChildItems.Add(New MenuItem("Mis Compras", "Compras", Nothing, "/MyOrders.aspx"))
        Me.Menu.Items.Item(7).ChildItems.Add(New MenuItem("Lista de Productos", "Productos", Nothing, "/ProductList.aspx"))
        Me.Menu.Items.Add(New MenuItem("Equipo", "AdminEqu"))
        Me.Menu.Items.Item(8).ChildItems.Add(New MenuItem("Crear Equipo", "Equipo", Nothing, "/CrearEquipo.aspx"))
        Me.Menu.Items.Item(8).ChildItems.Add(New MenuItem("Enviar Invitacion", "EnviarInvitacion", Nothing, "/EnviarInvitacion.aspx"))
        Me.Menu.Items.Item(8).ChildItems.Add(New MenuItem("Inscribir Torneo", "InscribirTorneo", Nothing, "/InscribirTorneo.aspx"))
        Me.Menu.Items.Add(New MenuItem("Jugador", "AdminJug"))
        Me.Menu.Items.Item(9).ChildItems.Add(New MenuItem("Crear Perfil Jugador", "PerfilJugador", Nothing, "/AgregarPerfilJugador.aspx"))
        Me.Menu.Items.Item(9).ChildItems.Add(New MenuItem("Enviar Solicitud", "EnviarSolicitud", Nothing, "/EnviarSolicitud.aspx"))
        Me.Menu.Items.Add(New MenuItem("Cambiar Idioma", "SeleccionarIdioma", Nothing, "/SeleccionarIdioma.aspx"))
