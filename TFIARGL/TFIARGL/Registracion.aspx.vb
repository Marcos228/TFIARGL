        ...
        Try
            ...
            If Page.IsValid = True Then
                ...
                If GestorCliente.Alta(usu) Then
                    Dim Bitac As New Entidades.BitacoraAuditoria(usu, IdiomaActual.Palabras.Find(Function(p) p.Codigo = "BitacoraRegistrSuccess1").Traduccion & usu.Nombre & ".", Entidades.Tipo_Bitacora.Modificacion, Now.AddMilliseconds(-Now.Millisecond), Request.UserAgent, Request.UserHostAddress, "", "")
