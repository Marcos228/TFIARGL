<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="ModificarIdioma.aspx.vb" Inherits="Vista.ModificarIdioma" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        ...
        <div id="success" runat="server" name="success" class="alert alert-success  text-center" visible="false">
            <label id="lblsuccessmodIdioma" class="text-success">El Idioma se modificó correctamente.</label>
        </div>
                ...
                <div class="panel panel-success">
                    ...
                    <div class="panel-body FondoPanel">
                        ...
                        <div id="botont" runat="server" class="row">
                            <div class="col-md-4 col-md-offset-4">
                                <asp:Button ClientIDMode="Static" ID="btnmodIdioma" name="btnmodIdioma" runat="server" Text="Modificar Idioma" CssClass="btn btn-block btn-warning" />
                            </div>
                        </div>
                        <br />
                    </div>
