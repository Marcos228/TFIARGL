...
Public Class SortearTorneo
    ...
    Protected Sub btnSortear_Click(sender As Object, e As EventArgs) Handles btnSortear.Click
        Try
            ...
            For Each part In TorneoSorteo.Partidas
                part.ID_Partida = index
                index += 1
            Next
    ...
    Private Sub CargarPArtidas(ByRef Torneo As Entidades.Torneo)
        Try
            ...
            For Each PArtida As Entidades.Partida In Torneo.Partidas
                If PArtida.FechaHora = Date.MinValue Then
                    finalizado = False
                    Exit For
                End If
    ...
    Protected Sub btnAsignar_Click(sender As Object, e As EventArgs) Handles btnAsignar.Click
        ...
        TryCast(Session("Partida"), Entidades.Partida).FechaHora = datepicker1.Value & " " & timepicker1.Value
        CargarPArtidas(Session("Torneo"))
    ...
    Protected Sub btnFinalizar_Click(sender As Object, e As EventArgs) Handles btnFinalizar.Click
        Try
            ...
            GestorTorneo.FinalizarSorteo(TorneoSorteo)
