<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="BuscarTorneo.aspx.vb" Inherits="Vista.BuscarTorneo" MaintainScrollPositionOnPostback="true" %>
            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-success">
                    <div class="panel-heading text-center">
                        <asp:Label ID="lblPanelBusTorneo" runat="server" Text="Buscar Torneo" CssClass="TituloPanel"></asp:Label>
                    </div>
