...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        ...
        <div id="success" runat="server" name="success" class="alert alert-success  text-center" visible="false">
            <label  id="Label1" class="text-success">Se cambió la contraseña correctamente.</label>
        </div>
                ...
                <div class="panel panel-warning">
                    ...
                    <div class="panel-body FondoPanel">
                        <div class="form-horizontal has-warning">
                            ...
                            <div class="form-group">
                                <asp:Label ID="lblcuil" runat="server" Text="Cuil/Cuit:" CssClass="col-sm-4 control-label labelform"></asp:Label>
                                <div class="col-md-6">
                                    <div class="input-group">
                                ...
                                <div class="col-md-1">
                                    <asp:RequiredFieldValidator ID="Rtxtcuil" runat="server" ControlToValidate="txtcuil" ErrorMessage="*" EnableClientScript="false" Display="Dynamic" CssClass="textoValidacion"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="form-group">

                                <asp:Label ID="lblPassword" runat="server" Text="Nueva Contraseña:" CssClass="col-sm-4 control-label labelform"></asp:Label>
                                <div class="col-md-6">
                                    <div class="input-group">
